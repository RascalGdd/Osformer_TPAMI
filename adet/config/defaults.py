...
_C.MODEL.OSFormer.QS.NUM_MASKS = 100
...
_C.MODEL.OSFormer.LOSS.MASK_DICE_WEIGHT = 2.0
# iou-aware objectness loss weight
_C.MODEL.OSFormer.LOSS.OBJECTNESS_WEIGHT = 1.0

# [Matcher]
_C.MODEL.OSFormer.MATCHER = CN()
_C.MODEL.OSFormer.MATCHER.NAME = "SparseInstMatcher"
_C.MODEL.OSFormer.MATCHER.ALPHA = 0.8
_C.MODEL.OSFormer.MATCHER.BETA = 0.2

# parameters for inference
_C.MODEL.OSFormer.CLS_THRESHOLD = 0.005
_C.MODEL.OSFormer.MASK_THRESHOLD = 0.45
_C.MODEL.OSFormer.MAX_DETECTIONS = 100